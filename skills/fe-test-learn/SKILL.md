---
name: fe-test-learn
description: Save a testing decision or learning to memory. Use when you want to explicitly remember a decision, pattern, or lesson from any session — the fe-test pipeline does not prompt for this automatically.
---
...
- You made a decision during a test session worth keeping
...
- General → use Glob to find `**/fe-test/knowledge/global-learnings.md` and append to it
