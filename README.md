...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/shashank-koppunoori302/testing-demo/main/install.sh)
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/shashank-koppunoori302/testing-demo/main/install.sh | bash -s -- --claude
```
